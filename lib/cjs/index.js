    ...
    createSingleWebinar({ start, end, name, agenda, account, password, approval, recording, }) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                const registrationCode = approval ? (0, helpers_1.registrationTypeToNumber)(approval) : 0;
                const requestBody = {
                    topic: name,
                    type: 5,
            ...
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    for (let i = 0; i < instances.length; i++) {
                        ...
                        userList.concat(yield (0, helpers_1.paginationWebinarParticipants)(this._zoom, instances[i]));
                    }
                    resolve(userList);
                }
                catch (error) {
