...
export default class ZoomClient {
    constructor({ apiKey, secretKey, timezone, user }) {
        ...
        __classPrivateFieldSet(this, _ZoomClient_zoom, axios.create({
            ...
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    for (let i = 0; i < instances.length; i++) {
                        ...
                        userList.concat(yield paginationWebinarParticipants(__classPrivateFieldGet(this, _ZoomClient_zoom, "f"), instances[i]));
                    }
                    resolve(userList);
                }
                catch (error) {
